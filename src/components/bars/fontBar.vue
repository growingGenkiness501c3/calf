...
<template>
  ...
  <center>
    <div class="grid grid-cols-17 gap-1 w-full">
      <div class="col-span-17 grid grid-cols-17 gap-1 ">
        <div class="p-2 border text-center text-[20px]">class="alumni-sans-pinstripe-regular text-[20px]"</div>
        <div class="p-2 border text-center text-[20px]">class="alumni-sans-pinstripe-regular-italic text-[20px]"</div>
        <div class="p-2 border text-center text-[18px]">class="anonymous-pro-regular text-[18px]"</div>
        <div class="p-2 border text-center text-[18px]">class="anonymous-pro-bold text-[18px]"</div>
        <div class="p-2 border text-center text-[18px]">class="anonymous-pro-regular-italic text-[18px]"</div>
        <div class="p-2 border text-center text-[18px]">class="anonymous-pro-bold-italic text-[18px]"</div>
        <div class="p-2 border text-center text-[18px]">class="coral-pixels-regular text-[18px]"</div>
        <div class="p-2 border text-center text-[16px]">class="hubot-sans text-[16px]"</div>
        <div class="p-2 border text-center text-[16px]">class="mea-culpa-regular text-[16px]"</div>
        <div class="p-2 border text-center text-[13px]">class="orbitron text-[13px]"</div>
        <div class="p-2 border text-center text-[18px]">class="Oswald text-[18px]"</div>
        <div class="p-2 border text-center text-[20px]">class="rajdhani-light text-[18px]"</div>
        <div class="p-2 border text-center text-[20px]">class="rajdhani-regular text-[20px]"</div>
        <div class="p-2 border text-center text-[20px]">class="rajdhani-medium text-[20px]"</div>
        <div class="p-2 border text-center text-[20px]">class="rajdhani-semibold text-[20px]"</div>
        <div class="p-2 border text-center text-[20px]">class="rajdhani-bold text-[20px]"</div>
        <div class="p-2 border text-center text-[18px]">class="updock-regular text-[18px]"</div>
      </div>
